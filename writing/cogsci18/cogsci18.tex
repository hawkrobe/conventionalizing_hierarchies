...
Finally, the reaction time taken by the speaker to choose an utterance also decreases significantly over the course of the game, indicating that the lexical mappings are increasingly established [stat]. \todo[inline]{Refine how to say this\dots}
...
{\caption{{\footnotesize \todo[inline]{TODO: Fix condition names; labels; bootstrap error bars for histogram}  \label{fig:lexiconContent}}}}
\end{center}
\end{figure*}
...
%{\includegraphics[scale=.64]{lexiconSize.pdf}}
{\caption{{\footnotesize \todo[inline]{TODO: fill bottom-right empty space with inset, or text stating 4th round area under curve (0.98)?\dots)}  \label{fig:postTestPrediction}}}}
\end{center}
\end{figure}
