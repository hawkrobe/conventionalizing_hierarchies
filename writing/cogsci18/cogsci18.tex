...
%{\includegraphics[scale=.64]{lexiconSize.pdf}}
{\caption{{\footnotesize \todo[inline]{TODO: Fix conditions; labels}  \label{fig:lexiconContent}}}}
\end{center}
\end{figure}
...
%{\includegraphics[scale=.64]{lexiconSize.pdf}}
{\caption{{\footnotesize \todo[inline]{TODO: placeholder for more schematic figure showing example of how lexicon inference changes as we see more and more data; would ideally make clear effect of different contexts}  \label{exp}}}}
\end{center}
\end{figure}
...
%{\includegraphics[scale=.64]{lexiconSize.pdf}}
{\caption{{\footnotesize \todo[inline]{TODO: placeholder for plot showing predictions for all games (currently only one game\dots)}  \label{exp}}}}
\end{center}
\end{figure}
