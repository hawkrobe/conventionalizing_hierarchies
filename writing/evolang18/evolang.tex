...
\author[2]{Kenny Smith} 
\author[3]{Michael Franke}
\author[1,4]{Noah D. Goodman}
\affil[*]{Corresponding Author: rxdh@stanford.edu}
\affil[1]{Department of Psychology, Stanford University, USA}
\affil[2]{Centre for Language Evolution, University of Edinburgh, UK}
\affil[3]{Department of Linguistics, University of T\"{u}bingen, Germany}
\affil[4]{Department of Computer Science, Stanford University, USA}
